...
export const seasonalProducts = [
  { id: 1, rank: 1, name: 'GAP 인증 자두 (대과)', price: '25,900원', discount: '13%', rating: '5.0', reviews: '999+', image: productImg5 },
  { id: 2, rank: 2, name: '해남 미니 밤호박 3kg', price: '19,900원', discount: '15%', rating: '4.9', reviews: '999+', image: productImg6 },
  { id: 3, rank: 3, name: '유기농 설향 딸기 1kg', price: '14,960원', discount: '12%', rating: '4.9', reviews: '875', image: productImg3 },
  { id: 4, rank: 4, name: '성주 꿀 참외 2kg', price: '22,500원', discount: '18%', rating: '4.8', reviews: '762', image: productImg2 },
];
...
export const farmerStories = [
  {
    ...
    images: [postImg1],
    category: '농사일기',
    product: { id: 101, name: '무농약 꿀사과', price: '15,000원', image: productImg1, brand: '싱그러운 농장', discount: '10%' },
    tags: [{ y: 150, x: 150 }],
  ...
  },
  {
    ...
    images: [postImg2],
    category: '일상',
    product: { id: 102, name: '유기농 대추토마토', price: '12,000원', image: productImg2, brand: '행복 농원', discount: '5%' },
    tags: [{ y: 200, x: 100 }],
  ...
  },
   {
    ...
    images: [productImg3],
    category: '꿀팁',
    product: { id: 103, name: '논산 설향 딸기 1kg', price: '24,000원', image: productImg1, brand: '딸기농장', discount: '8%' },
    tags: [{ y: 180, x: 120 }],
