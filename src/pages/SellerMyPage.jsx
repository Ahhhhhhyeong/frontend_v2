    ...
    <div className='w-full bg-gray-100 h-full overflow-y-auto'>
      ...
      <div className='w-full bg-white pt-4 px-5 pb-6'>
        <div className='flex items-center space-x-3'>
          ...
          <Link
            to='/mypage'
            className='flex-shrink-0 px-3 py-2 bg-gray-100 rounded-lg text-gray-700 font-medium text-sm border border-gray-200'>
            고객으로 전환
          </Link>
        </div>
      ...
      <div className='bg-white'>
        ...
        <div className='mt-2'>
          ...
          <Link
            // to='/seller-mypage/product-inquiries'
            className='flex justify-between items-center p-5 border-b'>
            <span className='text-base font-medium text-gray-800 flex items-center gap-2'>
              상품 문의 관리
              <span className='text-sm text-green-600 font-bold bg-green-100 w-5 h-5 flex items-center justify-center rounded-full'>
