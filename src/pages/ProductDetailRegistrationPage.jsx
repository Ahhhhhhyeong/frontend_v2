  ...
  return (
    <div className={styles.detailSection}>
      ...
      <input
        ...
        accept='image/*'
        style={{ display: 'none' }}
        onChange={(e) => setDetailImage(index, e.target.files[0])}
      />
      <div className={styles.inputGroup}>
        <div className={styles.inputHeader}>
          <label className={styles.label}>제목</label>
          <button onClick={() => handleUseExample('title')} className={styles.exampleButton}>
            예시 사용
          </button>
        </div>
        <input
          ...
          value={detail.title}
          onChange={(e) => setDetailField(index, 'title', e.target.value)}
      ...
      <div className={styles.inputGroup}>
        <div className={styles.inputHeader}>
          ...
          <button onClick={() => handleUseExample('content')} className={styles.exampleButton}>
            예시 사용
          </button>
        </div>
        <textarea
          ...
          onChange={(e) => setDetailField(index, 'content', e.target.value)}
...
export default function ProductDetailRegistrationPage() {
  ...
  const { options, discount, setData, addOption, updateOption, removeOption, reset, ...productData } =
    useProductStore();
