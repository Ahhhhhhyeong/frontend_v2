...
export default function CommunityPage() {
  const { posts } = useCommunity(); // ✨ Context에서 게시물 목록 가져오기
  ...
  return (
    <div className="relative pb-24">
      <div className="flex w-full items-center gap-2 px-4 py-2 overflow-x-auto bg-white border-b sticky top-[54px] z-10">
      ...
      <Link to="/community/write" className="fixed bottom-20 right-4 z-20">
