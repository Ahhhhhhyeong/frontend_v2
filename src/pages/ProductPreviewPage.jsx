...
export default function ProductPreviewPage() {
    ...
    return (
        <div className={styles.div}>
            {/* 메인 이미지 */}
            <img className={styles.imgIcon} src={product.mainImage || 'https://placehold.co/375x375?text=Image'} alt="대표 이미지" />
                ...
                <div className={styles.info}>
                    <div className={styles.brand}>
                        <div className={styles.brand1}>
                            <img className={styles.brandChild} src={product.mainImage || 'https://placehold.co/28x28'} alt="농장 프로필" />
